...
CREATE TABLE [Post] (
    ...
    CONSTRAINT [FK_Post_Category_CategoryId] FOREIGN KEY ([CategoryId]) REFERENCES [Category] ([Id]) ON DELETE CASCADE
);
GO
...
CREATE TABLE [PostTag] (
    ...
    CONSTRAINT [FK_PostTag_PostTId] FOREIGN KEY ([PostId]) REFERENCES [Tag] ([Id]) ON DELETE CASCADE,
...
VALUES (N'20230430051728_InitialCreation', N'7.0.5');
GO
